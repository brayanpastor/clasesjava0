 ...
 * @author brapastor
 */
public class f_actor extends javax.swing.JFrame {
    ...
    private void cmdbuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdbuscarActionPerformed
        ...
        try {
            tabla.removeRow(tabla.getRowCount()-1);
            f1.llenar(2,"title",txtbuscar.getText());
    ...
    private void cbocategoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbocategoriaActionPerformed
        ...
        try {
            ...
            f1.llenar(3,"name",cbocategoria.getSelectedItem().toString());
            if (f1.totalregistro()>0)
            {
            tabla=(DefaultTableModel)this.tbtabla.getModel();
            tabla.setNumRows(0);
